...
import { SoundVibrationIcon } from '../components/Icons';
          ...
          <div className="flex flex-col md:flex-row lg:flex-col">
            ...
            <Card>
              <IoNotificationsSharp
                size={34}
                className="text-purple-500 my-3"
              />
...
SoundVibrationPage.displayName = 'SoundVibrationPage';
SoundVibrationPage.icon = SoundVibrationIcon;
